...
function createGameSystem(req, res) {
    ...
    try {
        ...
        return Gamesystems.create(
            ...
            {
                /*include: [ {model: order_detail, as: 'orderdetail'} ]*/
            }).then((parameters) =>
            {
                res.status(201).send(parameters); //mygamesystem
...
function getGameSystemById(req, res) {
    ...
    try {
        ...
        Gamesystems.findByPk(id).then(mygamesystem => {
...
//console.log("operadores.controller getOperadorById");
    ...
    try {
        ...
        console.log("update gamesystems ... " + myupdategamesystem.name + " " + myupdategamesystem.description);
